...
class Model(nn.Module):
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None):
        B, L, M = x_enc.shape # B: batch size, L: time steps, M: number of variables
        ...
        dec_in, n_vars = self.enc_embedding(x_enc) # [B * M, N, D] # value_embedding + position_embedding # N: Number of Patch, D: d_model
