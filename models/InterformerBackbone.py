...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.raw_patch_embedding = PatchEmbedding(
            self.d_model, self.patch_len, self.stride, padding, self.dropout
        )
        ...
        self.encoder = Encoder(
            ...
            #             backcast_length=configs.d_model * configs.token_len,
            #             forecast_length=configs.d_model * configs.token_len,
            #         ),
            #         TrendLayer(
            #             theta_dim=4,
            #             device=configs.devices,
        ...
        self.quantile_proj = nn.Linear(
            self.d_model, self.d_model * len(configs.quantilies), bias=True
        )
